...
func ReadMessage(c echo.Context) error {
	return c.String(http.StatusOK, "read message")
	// return nil
}
...
func EditMessage(c echo.Context) error {
	return c.String(http.StatusOK, "edit message")
}

func DeleteMessage(c echo.Context) error {
	return c.String(http.StatusOK, "delete message")
}

func WebSocketMessage(c echo.Context) error {
	return c.String(http.StatusOK, "websocket message")
}
